...
VeloceDraft is a specialized 2D CAD application designed specifically for **Precision 2D Pattern** editing. It bridges the gap between high-end CAD software and manual drafting by providing a parametric, lightweight, and manufacturing-ready environment.

![Header Screenshot](file:///c:/Users/toshi/python/VeloceDraft/production_artifacts/browser_screenshots/03_entities.png)

## Core Features

-   **Parametric Rounded Rects**: First-class support for custom shapes with adjustable corner radii (rx, ry).
-   **Pattern Array Generator**: One-click generation of 1D/2D array patterns with configurable counts and pitches.
